...
if __name__ == '__main__':
    ...
    # save model
    pickle.dump(dt_model, open('models/decision_tree_completion.p', 'wb')) 
    ...
    print('Best Model: {}'.format(dt_model))
    print('Best Model parameters: {}'.format(dt_clf.best_params_))
    print('Best Model Recall: {}'.format(recall))
